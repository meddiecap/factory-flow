...
// The EnergySupply overflow tests (improvement 8) have been removed because
// EnergySupply is now an autonomous generator with cycleDuration=0 and no outputs.
// It is skipped by tickNode entirely and is no longer subject to output-blocked logic.
